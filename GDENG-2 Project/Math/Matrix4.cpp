...
Matrix4::Matrix4(const Vector3D& r0,
                 const Vector3D& r1,
                 const Vector3D& r2) :
...
Matrix4 Matrix4::CreateTranslation(const Vector3D& position) noexcept
{
	using namespace DirectX;
	Matrix4 result;
...
Matrix4 Matrix4::CreateScale(const Vector3D& scales) noexcept
{
	using namespace DirectX;
	Matrix4 result;
...
// Matrix4 Matrix4::CreateLookAt(Vector3D eye,
//                               Vector3D focus,
//                               Vector3D up)
// {
// 	using namespace DirectX;
